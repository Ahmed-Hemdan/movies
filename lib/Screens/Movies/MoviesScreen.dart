...
import 'package:movies/Screens/Movies/OneMovieScreen.dart';
      ...
      child: BlocBuilder<AppCubit, AppStates>(
        builder: (context, state) => StreamBuilder(
          builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
            if (AppCubit.get(context).theMovies.isEmpty) {
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: ListView.separated(
                          ...
                          itemCount: AppCubit.get(context).theMovies.length),
                    ),
                  ),
                ],
              );
